...
"#
    ...
    // Regression: generated semantic/native keybinds own conflicting unbind cleanup in the child renderer.
    #[test]
    ...
    // Defends: main passes explicit action specs, while child renders the MessagePlugin KDL.
    #[test]
    ...
    // Defends: child-owned native rendering preserves multi-line Zellij action blocks.
    #[test]
    ...
    // Defends: child-owned planner rejects invalid sidebar geometry before KDL rendering.
    #[test]
    ...
    // Defends: status-bar widget tray entries are validated in the child planner before runtime rendering.
    #[test]
    ...
    // Defends: usage widget periods are normalized and deduplicated before the child bar renderer sees them.
    #[test]
    ...
    // Defends: child-owned planner keeps explicit screen saver config normalized and bounded before pane-orchestrator KDL.
    #[test]
