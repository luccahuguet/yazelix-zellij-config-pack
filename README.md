...
Deterministic Zellij config and layout renderer extracted from Yazelix.
...
Main Yazelix still owns product policy: settings normalization, runtime paths, plugin artifact resolution, generated file writes, doctor/repair, and workspace/session behavior.
